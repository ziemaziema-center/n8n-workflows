...
def company_prompt(task: dict[str, Any]) -> str:
    ...
    return "\n".join(
        [
            ...
            "- Before planning new docs or frameworks, ask: What part of the operating system does this improve?",
            "- Classify project work as Runtime, Queue, Orchestration, Validation, Telemetry, Review, Retry, Continuation, Growth, or Infrastructure.",
            "- Prefer working runtime over new documentation, automation over manual process, persistent execution over single execution, and operating-system capability over project-specific customization.",
            "- Optimize for maturity of the persistent AI operating system, not superficial task completion.",
            "",
