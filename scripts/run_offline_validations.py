    ...
    checks = [
        ...
        run(
            [
                ...
                "scripts/create_worldvape_daily_growth_queue.py",
                "scripts/run_worldvape_daily_growth_once.py",
                "scripts/classify_prompt_surface.py",
                "src/tac/runtime_engine.py",
                "src/tac/prompt_surface.py",
            ]
        ),
        ...
        run([sys.executable, "scripts/simulate_runtime_persistence.py"]),
