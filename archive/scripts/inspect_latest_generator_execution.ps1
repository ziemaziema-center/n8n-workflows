...
$execs = Invoke-RestMethod -Headers $headers -Uri "$baseUrl/executions?workflowId=$workflowId&limit=3&includeData=true"
$execs.data | Select-Object id,status,startedAt,finishedAt | ConvertTo-Json -Depth 5
